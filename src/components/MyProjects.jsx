...
// import styles
import "../styles/components/MyProjects.css";
...
const projects = [
  {
    ...
    description:
      "implementation from scratch of a school website with Html and Css only",
...

  {
    title: "Web front end",
    description:
      "front-end exercise, overview of the tech learned for the front",
...

  {
    ...
    description:
      "implementation from scratch of a school website with Html Css and Bootstrap",
...

  {
    ...
    description:
      "web application that show the price of cryptocurrencies with CoinGecko API",
    github:
      "https://github.com/Pixeloceax/React_project/tree/main/cryptocurencies",
  },
